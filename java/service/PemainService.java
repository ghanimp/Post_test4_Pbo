...
public class PemainService {
    ...
    public void tambahPemain() {
        ...
        if (jenis.equals("1")) {
            ...
            pemainList.add(new PemainSenior(nama, klub, posisi, nomorPunggung, usia, penghargaan));
            ...
            pemainList.add(new PemainAkademi(nama, klub, posisi, nomorPunggung, usia, akademi, tahunMasuk));
        }

        System.out.println("Pemain berhasil ditambahkan!\n");

        pemainList.get(pemainList.size() - 1).tampilkanPerforma();
    }
    ...
    public void tampilkanPemain() {
        ...
        for (Pemain p : pemainList) {
            ...
            if (tampil && p instanceof Performa) {
                System.out.print(i + ". ");
                ((Performa) p).tampilkanInfo(); // 🔹 sekarang pakai Performa
                i++;
            }
        }
